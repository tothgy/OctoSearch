//
//  StubSearchSucessResponse.swift
//  OctoSearchTests
//
...
struct StubSearchSucessResponse {
    
    static let successResponse: EndpointSampleResponse = .networkResponse(200, StubSearchSucessResponse.responseData)
    
    static let response: [Repository] = [
        Repository(
            id: 3081286,
            name: "Tetris",
            fullName: "dtrupenn/Tetris",
            htmlUrl: "https://github.com/dtrupenn/Tetris",
            repositoryDescription: "A C implementation of Tetris using Pennsim through LC4")
    ]
